...
vi.mock('@renderer/components/script-editor/ScriptTimelineView', () => ({
...
describe('PanelSystem — compose & script layout routing', () => {
  ...
  it('renders ScriptTimelineView when preset is script', () => {
    render(<PanelSystem preset="script" />)
    expect(screen.getByTestId('script-timeline-view')).toBeDefined()
